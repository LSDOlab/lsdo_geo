...
class SystemRepresentationOutputsCSDL(csdl.Model):
    ...
    def define(self):
        ...
        # Declare input
        system_representation_geometry = self.declare_variable('system_representation_geometry', val=spatial_rep.coefficients['geometry'])
...
class NonlinearOutputsOperation(csdl.CustomExplicitOperation):
    ...
    def define(self):
        ...
        self.add_input('system_representation_geometry', val=spatial_rep.coefficients['geometry'].copy())
