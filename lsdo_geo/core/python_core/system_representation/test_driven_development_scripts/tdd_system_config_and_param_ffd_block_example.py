...
# from caddee.primitives.bsplines.bspline_functions import create_bspline_from_corners
...
# wing_ffd_block.add_scale_v(name='quadratic_taper', order=3, num_dof=3, cost_factor=1.)
...
# spatial_rep.plot_meshes(plotting_meshes, mesh_plot_types=['point_cloud'], mesh_opacity=1.)
spatial_rep.plot_meshes(plotting_meshes, mesh_plot_types=['wireframe'], mesh_opacity=1.)
# spatial_rep.plot_meshes(plotting_meshes, mesh_plot_types=['mesh'], mesh_opacity=1.)
# spatial_rep.plot_meshes(plotting_meshes, mesh_plot_types=['mesh', 'wireframe'], mesh_opacity=1.)
# geo.plot_meshes([wing_camber_surface.value], mesh_plot_type='wireframe', mesh_opacity=1.)

wing_ffd_block.setup()
...
affine_ffd_control_points_local_frame = wing_ffd_block.evaluate_affine_block_deformations(plot=True)
ffd_control_points_local_frame = wing_ffd_block.evaluate_rotational_block_deformations(plot=True)
ffd_control_points = wing_ffd_block.evaluate_control_points(plot=True)
updated_wing = wing_ffd_block.evaluate_embedded_entities(plot=True)
...
print('Sample evaluation: pre-rotation local ffd control points \n', affine_ffd_control_points_local_frame)
print('Sample evaluation: local ffd control points \n', ffd_control_points_local_frame)
print('Sample evaluation: ffd control points \n', ffd_control_points)
print('Sample evaluation: geometry \n', updated_wing)
