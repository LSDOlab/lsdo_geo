...
# wing_ffd_b_spline_volume = create_b_spline_from_corners(points, order=(4,3,2), num_coefficients=(10,4,3))
...
affine_ffd_coefficients_local_frame = wing_ffd_block.evaluate_affine_block_deformations(plot=True)
ffd_coefficients_local_frame = wing_ffd_block.evaluate_rotational_block_deformations(plot=True)
ffd_coefficients = wing_ffd_block.evaluate_coefficients(plot=True)
