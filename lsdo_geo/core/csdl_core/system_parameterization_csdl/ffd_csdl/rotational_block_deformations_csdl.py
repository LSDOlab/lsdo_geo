...
if __name__ == "__main__":
    ...
    wing_ffd_block.plot_sections(control_points=sim['rotated_ffd_control_points'].reshape(wing_ffd_b_spline_volume.shape), offset_sections=True, plot_embedded_entities=False, opacity=0.75, show=True)
    wing_ffd_block.plot_sections(control_points=rotated_ffd_control_points.reshape(wing_ffd_b_spline_volume.shape), offset_sections=True, plot_embedded_entities=False, opacity=0.75, show=True)
    ...
    wing_ffd_block.plot_sections(control_points=(sim['rotated_ffd_control_points'][0:11*2*2,:]).reshape(wing_ffd_b_spline_volume.shape), offset_sections=True, plot_embedded_entities=False, opacity=0.75, show=True)
    horizontal_stabilizer_ffd_block.plot_sections(control_points=(sim['rotated_ffd_control_points'][11*2*2:,:]).reshape(horizontal_stabilizer_ffd_b_spline_volume.shape), offset_sections=True, plot_embedded_entities=False, opacity=0.75, show=True)
