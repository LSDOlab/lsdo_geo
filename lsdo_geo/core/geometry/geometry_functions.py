...
def S_of(q):
    ...
    W = W.set(csdl.slice[0, 1], q0)
    W = W.set(csdl.slice[0, 2], -q3)
    W = W.set(csdl.slice[0, 3], q2)
    W = W.set(csdl.slice[1, 1], q3)
    W = W.set(csdl.slice[1, 2], q0)
    W = W.set(csdl.slice[1, 3], -q1)
    W = W.set(csdl.slice[2, 1], -q2)
    W = W.set(csdl.slice[2, 2], q1)
    W = W.set(csdl.slice[2, 3], q0)
    S = 2*W
    return S