...
t2 = time.time()
geometry.refit(parallelize=True, fit_resolution=(100,100), num_coefficients=(30,30))
t3 = time.time()
...
wing_sweep_coefficients = csdl.Variable(name='wing_sweep_coefficients', shape=(2,), value=np.array([1., 0.]))
...
wing_dihedral_coefficients = csdl.Variable(name='wing_dihedral_coefficients', shape=(2,), value=np.array([1., 0.]))
...
wing_wingspan_stretch_coefficients = csdl.Variable(name='wingspan_stretch_coefficients', shape=(2,), value=np.array([-1., 0.]))
...
wing_chord_stretch_coefficients = csdl.Variable(name='wing_chord_stretch_coefficients', shape=(3,), 
...
wing_twist_coefficients = csdl.Variable(name='wing_twist_coefficients', shape=(5,),
...
#     # wing_sweep = csdl.Variable('wing_sweep', 
...
#     wing_diheral = csdl.Variable(name='wing_diheral', shape=(wing_ffd_block_sectional_parameterization.num_sections,),
#                                                         value=parameter_values)
#     # wing_chord_stretch = csdl.Variable('wing_chord_stretch',
#     #                                                      shape=(wing_ffd_block_sectional_parameterization.num_sections,),
#     #                                                       value=np.linspace(-.5, 0., wing_ffd_block_sectional_parameterization.num_sections))
#     # wing_twist = csdl.Variable('wing_twist',
#     #                                                      shape=(wing_ffd_block_sectional_parameterization.num_sections,),
...
#     # wing_diheral = csdl.Variable(name='wing_diheral', shape=(wing_ffd_block_sectional_parameterization.num_sections,),
#     #                                                     value=parameter_values)
#     wing_chord_stretch = csdl.Variable(name='wing_chord_stretch',
#                                                          shape=(wing_ffd_block_sectional_parameterization.num_sections,),
#                                                           value=parameter_values)
#     # wing_twist = csdl.Variable('wing_twist',
#     #                                                      shape=(wing_ffd_block_sectional_parameterization.num_sections,),
...
#     #                                                      shape=(wing_ffd_block_sectional_parameterization.num_sections,),
#     #                                                       value=parameter_values)
#     wing_twist = csdl.Variable(name='wing_twist',
#                                                          shape=(wing_ffd_block_sectional_parameterization.num_sections,),
#                                                           value=parameter_values)
#     sectional_parameters = {
#         # 'wing_sweep':wing_sectional_sweep, 
...
#     # wing_sweep_coefficients = csdl.Variable(name='wing_sweep_coefficients', shape=(2,), value=np.array([1., 0.]))
#     # wing_dihedral_coefficients = csdl.Variable(name='wing_dihedral_coefficients', shape=(2,), value=np.array([1., 0.]))
#     wing_wingspan_stretch_coefficients = csdl.Variable(name='wingspan_stretch_coefficients', shape=(2,), value=np.array([-parameter_value, parameter_value]))
#     # wing_chord_stretch_coefficients = csdl.Variable(name='wing_chord_stretch_coefficients', shape=(3,), value=np.array([-0.5, -0.1, 0.]))
#     # wing_twist_coefficients = csdl.Variable(name='wing_twist_coefficients', shape=(5,), value=np.array([0., 30., 20., 10., 0.]))
...
#     # wing_dihedral_coefficients = csdl.Variable(name='wing_dihedral_coefficients', shape=(2,), value=np.array([1., 0.]))
#     # wing_wingspan_stretch_coefficients = csdl.Variable(name='wingspan_stretch_coefficients', shape=(2,), value=np.array([-parameter_value, parameter_value]))
#     # wing_chord_stretch_coefficients = csdl.Variable(name='wing_chord_stretch_coefficients', shape=(3,), value=np.array([-0., parameter_value, 0.]))
#     # wing_twist_coefficients = csdl.Variable(name='wing_twist_coefficients', shape=(5,), value=np.array([0., 30., 20., 10., 0.]))
...
for i, parameter_value in enumerate(parameter_value_sweep):
    ...
    wing_sweep_coefficients = csdl.Variable(name='wing_sweep_coefficients', shape=(3,), value=np.array([parameter_value, 0., parameter_value]))
