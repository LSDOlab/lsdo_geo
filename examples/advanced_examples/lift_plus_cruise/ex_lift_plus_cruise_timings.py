...
plt.tight_layout()
plt.savefig('examples/advanced_examples/lift_plus_cruise/time_vs_input_norm_recreated.png', dpi=300, bbox_inches='tight')
plt.show()
...
with open('examples/advanced_examples/lift_plus_cruise/lhs_timing_results_with_norms.pkl', 'wb') as f:
